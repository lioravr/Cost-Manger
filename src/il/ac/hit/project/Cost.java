...
public class Cost {
    ...
    public void setDescription(String description) throws MyException {
        ...
        if (description.equals("")) {
            throw new MyException("the field description is empty!" +
    ...
    public void setSum(String sum) throws MyException {
        try{
          ...
          // if fail to convert the throw exception.
          catch (NumberFormatException e)
          {
              throw new MyException("the field sum not valid!" +
                      " please fill and try again");
          }
    }
    /**
    ...
    public void setCurrency(String currency) throws MyException {
        /* the right statement check
           if the string contain numbers
           if it is so it's throw Exception
        */
        if (currency.isBlank()) {
            throw new MyException("the field currency not valid!" +
                    " please fill and try again");
        }
     ...
     * @throws MyException A class that cover all the problem of the program.
     */
    public Cost(String description, String sum,
                String currency, Category category) throws MyException {
